...
def StartCamera():
        ...
        return render_template("login.html",message="Snap Taken SuccesFully")
...
def log_in():
        ...
        if request.form['cid'] != None and request.form['cid'] != "" and request.form['pin'] != None and request.form['pin'] != "":
                ...
                if(isRecordExist==1):
                        ...
                        # headers = {'authorization':"EFNGpbW32l5q06DXtxHCInors7heROPiuTJS8YvBkQLjcZm9yK3C0theg1y9arljqbM2PmnQNfxEUTWs",'Content-Type': "application/x-www-form-urlencoded",'Cache-Control': "no-cache",}
